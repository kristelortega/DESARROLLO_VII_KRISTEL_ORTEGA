...
$misComidas = ["Lasaña", "Pure de papas", "Sushi"]; // Reemplaza con tus comidas favoritas
$comidasAmigo = ["Salchipapa", "Hamburguesa", "Camarones"]; // Reemplaza con las comidas favoritas de tu amigo

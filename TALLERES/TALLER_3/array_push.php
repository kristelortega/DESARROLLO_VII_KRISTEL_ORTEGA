...
$misAmigos = ["Kevin", "Enrique", "Caroline"]; // Reemplaza esto con tu array de amigos
array_push($misAmigos, "Luis", "William"); // Reemplaza las comillas vacías con los nombres de tus amigos

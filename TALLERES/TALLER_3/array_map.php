...
$cosas = ["fresas", "autos", "castillo", "saxofon"];
$cosasMayusculas = array_map('strtoupper', $cosas);

echo "</br>Frutas originales: " . implode(", ", $cosas) . "</br>";
echo "Frutas en mayúsculas: " . implode(", ", $cosasMayusculas) . "</br>";
